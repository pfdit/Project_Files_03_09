...
public class RetailSystemDriver {
	...
	private void automaticallyCreateProducts() {
		//for(int i=0;i<4;i++){
			...
			stockDBControl.addNewProductToStockList(product, 22);
			product = new Product(
					"Apple MacBook Pro",
			...
			stockDBControl.addNewProductToStockList(product, 5);
			product = new Product(
					"HP Chromebook 11",
			...
			stockDBControl.addNewProductToStockList(product, 8);
			...
			stockDBControl.addNewProductToStockList(product, 7);
			product = new Product(
			...
			stockDBControl.addNewProductToStockList(product, 12);
			product = new Product(
					"Samsung Galaxy Note ",
			...
			stockDBControl.addNewProductToStockList(product, 10);
			...
			stockDBControl.addNewProductToStockList(product, 9);
			product = new Product(
			...
			stockDBControl.addNewProductToStockList(product, 2);
			product = new Product(
					"Apple iPhone 5S",
